...
def _run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        if needs_calibration:
            ...
            print("- Move every joint and the gripper from stop to stop and back.")
            print("- Two full end-to-end traversals are required for every motor.")
            ...
            print(f"Recording for up to {args.seconds:.1f} seconds; finishing when all six reach 2/2...")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--seconds", type=float, default=90.0, help="two-traversal calibration duration")
